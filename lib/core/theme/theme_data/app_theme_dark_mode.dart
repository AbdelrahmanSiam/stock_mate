  ...
  static ThemeData getDarkTheme() => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: const BorderSide(color: AppColorsDarkMode.border, width: 1),
      ),
      // focused field
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty.resolveWith((states) {
        ...
        return const TextStyle(color: AppColorsDarkMode.textSecondary);
      }),
    ),
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12),
        side: const BorderSide(color: AppColorsDarkMode.border, width: 1),
      ),
